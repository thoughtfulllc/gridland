...
// The opentui-web module chain contains top-level await (reconciler devtools),
// so require() fails — we use await import() here instead.
const _webModule = await import("../../opentui-web/src/index")
const _rendererModule = await import("../../opentui-web/src/browser-renderer")
const _coreModule = await import("../../opentui-web/src/core-shims/index").catch(() => {
  throw new Error(
...
/**
 * Render an OpenTUI component for testing.
 *
 * Note: This function requires @opentui/core and the opentui-web browser runtime
