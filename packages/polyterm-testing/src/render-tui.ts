...
// The polyterm-web module chain contains top-level await (reconciler devtools),
// so require() fails — we use await import() here instead.
const _webModule = await import("../../polyterm-web/src/index")
const _rendererModule = await import("../../polyterm-web/src/browser-renderer")
const _coreModule = await import("../../polyterm-web/src/core-shims/index").catch(() => {
  throw new Error(
 ...
 *
 * Note: This function requires @opentui/core and the polyterm-web browser runtime
