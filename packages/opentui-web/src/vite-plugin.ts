...
export interface OpenTuiWebPluginOptions {
  /**
...
/**
 * Vite plugin that sets up module resolution for opentui-web.
 * Handles:
 ...
 */
export function opentuiWebPlugin(options: OpenTuiWebPluginOptions): Plugin[] {
  ...
  const aliasPlugin: Plugin = {
    ...
    config() {
      ...
      // Resolve npm packages from opentui-web's node_modules so consuming
