...
description: Complete chat interface combining Message, PromptInput, and ChainOfThought with Vercel AI SDK
---
...
| [`ChainOfThought`](/docs/components/chain-of-thought) | Animated step chain of thought for reasoning chains (when model supports it) |
