...
| `focusedColor` | `string` | `"#cdd6f4"` | Text color for focused sidebar item |
| `selectedColor` | `string` | `"#a5b4fc"` | Text color for selected sidebar item |
| `mutedColor` | `string` | `"#6c7086"` | Text color for unfocused sidebar items |
| `highlightBg` | `string` | `"#313244"` | Background color for focused sidebar item |
| `borderColor` | `string` | `"#3b3466"` | Main panel border color |
| `activeBorderColor` | `string` | `"#818cf8"` | Main panel border color when interacting |
