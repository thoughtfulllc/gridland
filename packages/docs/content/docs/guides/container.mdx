...
|--------|---------|-------------|
| npm package | `cowsay` | Installs and runs the package bin |
...
```bash title="Terminal"
# Forward arguments to the package after --
bunx @gridland/container cowsay -- "Moo from a container"

# Run chalk-animation with the rainbow effect for 3 seconds
bunx @gridland/container chalk-animation -- rainbow --duration 3000 "Hello!"

# Run with no network access
bunx @gridland/container cowsay --no-network -- "Isolated moo"
