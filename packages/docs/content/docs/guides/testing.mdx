---
title: Testing
description: Test OpenTUI Web components with opentui-testing
---
...
<Tab value="npm">
```bash title="Terminal"
npm install --save-dev opentui-testing
```
</Tab>
<Tab value="yarn">
```bash title="Terminal"
yarn add -D opentui-testing
```
</Tab>
<Tab value="pnpm">
```bash title="Terminal"
pnpm add -D opentui-testing
```
</Tab>
<Tab value="bun">
```bash title="Terminal"
bun add -D opentui-testing
```
</Tab>
</Tabs>
...
import { createScreen } from "opentui-testing"
...
import { createScreen, keys } from "opentui-testing"
...
import { createScreen, waitFor } from "opentui-testing"
...
`opentui-testing` works with any test runner that supports ESM:

- **Bun** — Recommended, used in the opentui-web test suite
- **Vitest** — Works with proper module resolution
- **Jest** — Works with ESM transforms configured

<Callout type="info">
Bun is the recommended test runner for OpenTUI Web projects. It has native ESM
support and is used for the opentui-web test suite itself.
</Callout>
